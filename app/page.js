    ...
    <main className={styles.page}>
      <div className={styles.header}>
        ...
        <div className={styles.header_text}>
          <div>
            <h1 className={styles.name}>Simon Frisk</h1>
            <p className={styles.bio}>I'm a Ph.D. student at <a href="https://www.wisc.edu">University of Wisconsin-Madison</a>. I am most fortunate to be advised by Prof. <a href="https://pages.cs.wisc.edu/~paris/">Paraschos Koutris</a> in the <a href="https://database.cs.wisc.edu">database group</a>. I am broadly interested in query optimization.</p>
          </div>
      ...
      <section className={styles.researchSection}>
        ...
        <Publication
          ...
          website="https://www.flowlog-rs.com"
        />
        <Publication
